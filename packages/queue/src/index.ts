...
export {
  ...
  resolveQueryWindow,
  runCreativePerformanceQuery,
  runPerformanceCompare,
  runPerformanceQuery,
  type CreativeQueryInput,
  type CreativeQueryResult,
  type ParsedCreativeQueryInput,
  type ParsedPerformanceCompareInput,
  type ParsedPerformanceQueryInput,
  type PerformanceCompareInput,
  type PerformanceCompareResult,
  type PerformanceCompareRow,
